...
def sample_trajectory(env, policy, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while True:
        ...
        # TODONE end the rollout if the rollout ended
        # HINT: rollout can end due to done, or due to max_path_length
        # rollout_done = done or max_path_length # HINT: this is either 0 or 1
...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=True, render_mode=('rgb_array')):
    """
